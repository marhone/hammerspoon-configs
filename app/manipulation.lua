...
hs.hotkey.bind({"ctrl",        "cmd"}, "Left",  left_third)
hs.hotkey.bind({"ctrl",        "cmd"}, "Right", right_third)
hs.hotkey.bind({"ctrl",        "cmd"}, "Up",    up_third)
hs.hotkey.bind({"ctrl",        "cmd"}, "Down",  down_third)

-- Maximized
hs.hotkey.bind({"ctrl", "alt"       }, "F",     hs.fnutils.partial(winresize, "max"))